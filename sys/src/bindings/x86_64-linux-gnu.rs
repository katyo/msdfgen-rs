...
fn bindgen_test_layout_msdfgen_Vector2() {
    const UNINIT: ::std::mem::MaybeUninit<msdfgen_Vector2> = ::std::mem::MaybeUninit::uninit();
...
fn bindgen_test_layout_msdfgen_Projection() {
    const UNINIT: ::std::mem::MaybeUninit<msdfgen_Projection> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_msdfgen_Scanline_Intersection() {
    const UNINIT: ::std::mem::MaybeUninit<msdfgen_Scanline_Intersection> =
...
fn bindgen_test_layout_msdfgen_Scanline() {
    const UNINIT: ::std::mem::MaybeUninit<msdfgen_Scanline> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).intersections) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_msdfgen_SignedDistance() {
    const UNINIT: ::std::mem::MaybeUninit<msdfgen_SignedDistance> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_msdfgen_EdgeSegment() {
    const UNINIT: ::std::mem::MaybeUninit<msdfgen_EdgeSegment> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_msdfgen_LinearSegment() {
    const UNINIT: ::std::mem::MaybeUninit<msdfgen_LinearSegment> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_msdfgen_QuadraticSegment() {
    const UNINIT: ::std::mem::MaybeUninit<msdfgen_QuadraticSegment> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_msdfgen_CubicSegment() {
    const UNINIT: ::std::mem::MaybeUninit<msdfgen_CubicSegment> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_msdfgen_EdgeHolder() {
    const UNINIT: ::std::mem::MaybeUninit<msdfgen_EdgeHolder> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).edgeSegment) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_msdfgen_Contour() {
    const UNINIT: ::std::mem::MaybeUninit<msdfgen_Contour> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_msdfgen_Shape_Bounds() {
    const UNINIT: ::std::mem::MaybeUninit<msdfgen_Shape_Bounds> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_msdfgen_Shape() {
    const UNINIT: ::std::mem::MaybeUninit<msdfgen_Shape> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).inverseYAxis) as usize - ptr as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(msdfgen_Shape),
...
fn bindgen_test_layout_msdfgen_ErrorCorrectionConfig() {
    const UNINIT: ::std::mem::MaybeUninit<msdfgen_ErrorCorrectionConfig> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).distanceCheckMode) as usize - ptr as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(msdfgen_ErrorCorrectionConfig),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).minDeviationRatio) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(msdfgen_ErrorCorrectionConfig),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).minImproveRatio) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(msdfgen_ErrorCorrectionConfig),
...
fn bindgen_test_layout_msdfgen_GeneratorConfig() {
    const UNINIT: ::std::mem::MaybeUninit<msdfgen_GeneratorConfig> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).overlapSupport) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_msdfgen_MSDFGeneratorConfig() {
    const UNINIT: ::std::mem::MaybeUninit<msdfgen_MSDFGeneratorConfig> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).errorCorrection) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
